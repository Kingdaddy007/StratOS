# Historical cinematic vocabulary — not runtime filter guidance

> **Quarantined for Media Pack review.** This file is not an approved filter-avoidance guide. Never use it to obtain a pass, change language or translation to evade safeguards, conceal the actual subject of a request, or infer provider-policy behavior. It remains only as historical material for later evidence review; any retained film vocabulary must be separated from safety claims and revalidated before active use.
...
- [Filter-Safe Cinematic Vocabulary Database v1.0](#filter-safe-cinematic-vocabulary-database-v10)
  ...
  - [4. LIGHTING — Color Temperature & Atmosphere](#4-lighting-color-temperature-atmosphere)
  - [5. STYLE & TEXTURE](#5-style-texture)
  - [6. MOTION & TIMING](#6-motion-timing)
  - [7. SAFE ACTION & COMBAT VOCABULARY](#7-safe-action-combat-vocabulary)
  - [8. SAFE WEAPON VOCABULARY](#8-safe-weapon-vocabulary)
  - [9. SAFE CLOTHING & ARMOR VOCABULARY](#9-safe-clothing-armor-vocabulary)
  - [10. SAFE BODY & PHYSIQUE VOCABULARY](#10-safe-body-physique-vocabulary)
  - [11. VFX — Particles & Energy](#11-vfx-particles-energy)
  - [12. SOUND — Diegetic Audio](#12-sound-diegetic-audio)
  - [13. ENVIRONMENT — Safe Scene-Setting](#13-environment-safe-scene-setting)
  - [14. MATERIAL & SURFACE](#14-material-surface)
  - [15. PRODUCTION CONTEXT TOKENS (Filter Shield — Use 2-3 Per Prompt)](#15-production-context-tokens-filter-shield-use-2-3-per-prompt)

## Historical cinematic vocabulary database

This historical list contains cinematic translation terms. It does not establish that any wording is safe, permitted, or more likely to pass a provider filter.
...
### 7. ACTION & COMBAT VOCABULARY — CREATIVE CLARITY ONLY

Do not use this table to disguise restricted conduct or to alter a platform classification.
...
### 8. WEAPON VOCABULARY — CREATIVE CLARITY ONLY

Name an object truthfully when a permitted creative task requires it. Never substitute coded or euphemistic wording to bypass a safeguard.
...
### 15. DEPRECATED PRODUCTION-CONTEXT LIST

Do not use production language as a filter shield or to increase a pass rate. Production context belongs in a brief only when it is true and relevant to the creative task.
