# Historical Seedance Enforcement Research

This archived community research contains unverified February 2026 reporting. The 2026-07-13 primary-source pass did not corroborate its named-party, release-delay, filter, or suspension claims in current official ByteDance product documentation. Do not use it as current platform policy or legal fact. Use the parent `seedance-copyright` skill for runtime decisions.

## Contents

- [February 2026 enforcement context](#-feb-2026-enforcement-context)
- [Core principle](#the-core-principle)
- [Hard and soft blocks](#hard-blocks-always-refused)
- [Safe substitution table](#safe-substitution-table)
- [Real-person policy](#real-person-policy)
- [Architecture and buildings](#architecture--buildings)
- [Music and audio](#music--audio)
- [Practical checklist](#the-post-feb-15-practical-checklist)
